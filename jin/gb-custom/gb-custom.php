...
add_action( 'enqueue_block_editor_assets', function () {
	...
	wp_enqueue_style( 'jin-blocks-style', get_template_directory_uri() . '/gb-custom/jin-blocks/build/editor.css' );
	...
	wp_localize_script('jin-blocks-script', 'jin_inst_dir_gb', array(
		'install_dir' => $inst_dir,
	));
});
